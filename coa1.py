...
def create_canvas3(frame2):
    ...
    coa1 = tk.Canvas(frame2, bg="lightcoral", width=690, height=460)
    coa1.grid(row=0, column=0, sticky="nsew")

    coa1_upper = tk.Frame(coa1, width=690, height=80, bg='mediumseagreen')
    coa1.create_window(0, 0, anchor='center', window=coa1_upper)
    coa1_upper.grid(sticky='nsew')
    ...
    # Create the buttons
    button1 = tk.Button(coa1_upper, text="Announcement",command=show_announcement)
    button2 = tk.Button(coa1_upper, text="Lectures",command=show_lecture)
    ...
    canvas_announcement = tk.Canvas(coa1, bg="lightcoral", width=690, height=460)
    canvas_announcement.grid(row=1,column=0,sticky='nsew')

    canvas_lecture = tk.Canvas(coa1, bg="palegoldenrod", width=690, height=460)
