...
def create_canvas1(frame2):
    ...
    canvasd10a = tk.Canvas(frame2, bg="bisque", width=690, height=460)
    canvasd10a.grid(row=0, column=0, sticky="nsew")

    framed10a_upper = tk.Frame(canvasd10a, width=690, height=80, bg='palevioletred')
    canvasd10a.create_window(0, 0, anchor='center', window=framed10a_upper)
    framed10a_upper.grid(sticky='nsew')
    ...
    # Create the buttons
    button1 = tk.Button(framed10a_upper, text="Announcement",command=show_announcement)
    button2 = tk.Button(framed10a_upper, text="Lectures",command=show_lecture)
    ...
    # Create canvas_announcement, canvas_lecture, file_list_frame, and upload_button inside canvasd10a
    canvas_announcement = tk.Canvas(canvasd10a, bg="darkgrey", width=690, height=460)
    canvas_announcement.grid(row=1,column=0,sticky='nsew')

    canvas_lecture = tk.Canvas(canvasd10a, bg="mistyrose", width=690, height=460)
    canvas_lecture.grid(row=1,column=0,sticky='nsew')
    
        # Create the text box inside the chatbox frame
    chat_input1 = tk.Text(canvas_announcement, bg="white", width=60, height=4)  # Adjust width and height as needed
    chat_input1.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")  # Adjust padding as needed
    ...
    chat_input1.tag_config("default", foreground="darkgrey")  # Change the color of the default message
    chat_input1.bind("<Button-1>", clear_default_message)
        # Bind mousewheel event to enable scrolling
    chat_input1.bind("<MouseWheel>", on_mousewheel)
   
    # Create the "Post" button
    post_button = tk.Button(canvas_announcement, text="Post", command=post_message,background="black" ,foreground="white",font="bold")
    post_button.grid(row=1, column=0, padx=10, pady=5,sticky="sw")  # Adjust padding as needed
    

    # Create the "Cancel" button
    cancel_button = tk.Button(canvas_announcement, text="Cancel", command=cancel_message,background="black",foreground="white",font="bold")
    ...
    canvas_announcement.grid_rowconfigure(0, weight=1)  
    ...
    upload_button = tk.Button(canvas_announcement, text="Upload", command=upload_file,background="black",foreground="white",font="bold")
